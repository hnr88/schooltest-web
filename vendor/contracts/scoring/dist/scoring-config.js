...
exports.scoringConfigSchema = void 0;
/**
...
exports.scoringConfigSchema = zod_1.z.object({
    model_version: zod_1.z.string().min(1),
    reliable_change_z: zod_1.z.number(),
    coarse_step: zod_1.z.number().int().positive(),
    min_items_per_skill: zod_1.z.number().int().positive(),
