 ...
 */
import { z } from 'zod';
export declare const resultViewSupplementarySchema: z.ZodObject<{
...
export type ResultViewSupplementary = z.infer<typeof resultViewSupplementarySchema>;
/**
 ...
 */
export declare const resultViewProductiveScoresSchema: z.ZodRecord<z.ZodString, z.ZodUnknown>;
export type ResultViewProductiveScores = z.infer<typeof resultViewProductiveScoresSchema>;
