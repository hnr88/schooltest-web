...
export declare const scoringConfigSchema: z.ZodObject<{
    ...
    reliable_change_z: z.ZodNumber;
    coarse_step: z.ZodNumber;
    min_items_per_skill: z.ZodNumber;
    min_errors_for_patterns: z.ZodNumber;
    anchored_skills: z.ZodArray<z.ZodString>;
    low_confidence_se_threshold: z.ZodNull;
    require_complete_attempt: z.ZodBoolean;
}, z.core.$strip>;
