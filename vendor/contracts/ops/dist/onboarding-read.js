...
exports.onboardingReadResponseSchema = exports.onboardingStateSchema = exports.ONBOARDING_READ_KEYS = void 0;
exports.onboardingReadPath = onboardingReadPath;
exports.isLegacyOnboardingState = isLegacyOnboardingState;
exports.containsLinkMaterial = containsLinkMaterial;
/**
...
function onboardingReadPath(documentId) {
 ...
 */
exports.onboardingStateSchema = zod_1.z.strictObject({
    ...
    contact_first_name: zod_1.z.string().max(CONTACT_NAME_MAX).nullable(),
    contact_last_name: zod_1.z.string().max(CONTACT_NAME_MAX).nullable(),
    contact_email: zod_1.z.string().max(CONTACT_EMAIL_MAX).nullable(),
});
/** `{ data: OnboardingState }` — the 200 body of C-OPS-PORTAL-011. */
exports.onboardingReadResponseSchema = (0, core_1.dataEnvelope)(exports.onboardingStateSchema);
/**
 ...
 */
function isLegacyOnboardingState(body) {
    return core_1.schoolInvitationStateSchema.safeParse(body).success;
}
 ...
 */
function containsLinkMaterial(body) {
    let serialised;
    try {
