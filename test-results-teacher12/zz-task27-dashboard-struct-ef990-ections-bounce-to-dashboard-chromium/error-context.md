...
- Name: zz-task27-dashboard-structure.spec.ts >> task 27: dashboard route structure + role redirect >> parent: portal masked flag-OFF; school + teach sections bounce to /dashboard
- Location: tests/e2e/zz-task27-dashboard-structure.spec.ts:90:7
