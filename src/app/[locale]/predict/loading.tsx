// Task 09: route-level loading chrome for /eald/predict, shaped like its hero
    ...
    <div className="min-h-screen bg-background">
      <div className="bg-gradient-to-b from-white to-background pb-8 pt-16 sm:pb-12 sm:pt-20">
        <div className="mx-auto w-full max-w-eald px-6 text-center">
          ...
          <div className="mx-auto mt-4 h-10 w-11/12 animate-pulse rounded-md bg-muted" />
          <div className="mx-auto mt-3 h-10 w-7/12 animate-pulse rounded-md bg-muted" />
