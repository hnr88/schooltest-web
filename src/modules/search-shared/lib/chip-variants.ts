...
// Canonical shared filter-chip pill (spec §13.1) — the single source for every
// search pane's chip styling. active = solid primary; idle = white with input
// border, muted-foreground text, muted hover. Motion baseline: colour transition
// + press feedback, both disabled under prefers-reduced-motion.
