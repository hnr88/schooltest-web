...
export function StudentEaldFields({ form, showAcaraPhase }: StudentEaldFieldsProps) {
  ...
  return (
    <fieldset className="flex flex-col gap-4 rounded-xl border border-border p-4">
      ...
      <FieldShell id="student-first-language" label={t('firstLanguage')} errorText={errors.first_language?.message}>
        <NativeSelect id="student-first-language" className="w-full" {...register('first_language')}>
      ...
      {showAcaraPhase ? (
        ...
        >
          <NativeSelect id="student-acara-phase" className="w-full" {...register('acara_phase')}>
            <NativeSelectOption value="">{t('notSet')}</NativeSelectOption>
      ...
      >
        <Input id="student-other-languages" autoComplete="off" {...register('other_languages')} />
      </FieldShell>
      <FieldShell id="student-l1-literate" label={t('l1Literate')}>
        <NativeSelect id="student-l1-literate" className="w-full" {...register('l1_literate')}>
          <NativeSelectOption value="">{t('notSet')}</NativeSelectOption>
      ...
      <FieldShell id="student-prior-schooling" label={t('priorSchoolingInterrupted')}>
        <NativeSelect
