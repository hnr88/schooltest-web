  ...
  <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '56px 32px 0', display: 'flex', flexWrap: 'wrap', gap: '48px', justifyContent: 'space-between' }}>
    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '11px', marginTop: '16px' }}>
        <a href="/diagnose" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="13">Diagnose</a>
        <a href="/teach" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="14">Teach</a>
        <a href="/track" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="15">Track</a>
        <a href="/predict" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="16">Predict</a>
        <a href="/report" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="17">Report</a>
      </div>
    </div>
    <div>
      <div style={{ fontSize: '11.5px', fontWeight: '700', letterSpacing: '.09em', textTransform: 'uppercase', color: '#8FA3C7' }}>About</div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '11px', marginTop: '16px' }}>
        <a href="/#register" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="18">Contact the programme team</a>
        <a href="/#register" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="19">Privacy statement</a>
        <a href="/#register" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="20">Accessibility</a>
        <a href="/#register" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-teach-h="21">Terms of use</a>
      </div>
    </div>
    </div>
  </div>
