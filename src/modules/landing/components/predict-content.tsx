...
export function LandingPredictContent() {
  return (
...
<section data-screen-label="Hero" style={{ background: '#F7F9FC', borderBottom: '1px solid #E3E8F0' }}>
  <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 32px 60px' }}>
    <div>
      ...
      <p style={{ margin: '22px 0 0', fontSize: '18px', lineHeight: '1.6', color: '#475569', textWrap: 'pretty', maxWidth: '52ch' }}>One readiness indicator, aggregated from every subskill across all four domains. The exit call stays yours - the evidence behind it stops being a hunch.</p>
  ...
  <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '56px 32px 0', display: 'flex', flexWrap: 'wrap', gap: '48px', justifyContent: 'space-between' }}>
    ...
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '11px', marginTop: '16px' }}>
        <a href="/diagnose" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="11">Diagnose</a>
        <a href="/teach" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="12">Teach</a>
        <a href="/track" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="13">Track</a>
        <a href="/predict" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="14">Predict</a>
        <a href="/report" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="15">Report</a>
      </div>
    </div>
    <div>
      <div style={{ fontSize: '11.5px', fontWeight: '700', letterSpacing: '.09em', textTransform: 'uppercase', color: '#8FA3C7' }}>About</div>
      <div style={{ display: 'flex', flexDirection: 'column', gap: '11px', marginTop: '16px' }}>
        <a href="/#register" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="16">Contact the programme team</a>
        <a href="/#register" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="17">Privacy statement</a>
        <a href="/#register" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="18">Accessibility</a>
        <a href="/#register" style={{ fontSize: '13.5px', color: '#C7D6F2', textDecoration: 'none' }} data-predict-h="19">Terms of use</a>
      </div>
    </div>
    </div>
  </div>
