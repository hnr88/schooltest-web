...
export const LANDING_TEXT_KEYS = [
  ...
  'trustedBy.five', 'features.eyebrow', 'features.title',
  'features.questionTypes.title', 'features.questionTypes.description',
  'features.aiGrading.title', 'features.aiGrading.description',
  'features.analytics.title', 'features.analytics.description',
  'featureDetail.eyebrow', 'featureDetail.title', 'featureDetail.description',
  'featureDetail.checkOne', 'featureDetail.checkTwo', 'featureDetail.checkThree',
  'featureDetail.card.title', 'featureDetail.card.badge',
  'featureDetail.card.grammar', 'featureDetail.card.vocabulary', 'featureDetail.card.coherence',
  'featureDetail.card.scoreGrammar', 'featureDetail.card.scoreVocabulary',
  'featureDetail.card.scoreCoherence',
  'stats.deliveredValue', 'stats.deliveredLabel', 'stats.accuracyValue',
  'stats.accuracyLabel', 'stats.savedValue', 'stats.savedLabel', 'howItWorks.eyebrow',
  'howItWorks.stepOneTitle', 'howItWorks.stepOneDescription',
  ...
  'pricing.proFeatureOne', 'pricing.proFeatureTwo', 'pricing.proFeatureThree',
  'pricing.schoolName', 'pricing.schoolPrice', 'pricing.schoolCta',
  'pricing.schoolFeatureOne', 'pricing.schoolFeatureTwo', 'pricing.schoolFeatureThree',
  'faq.title',
  'faq.accountsQuestion', 'faq.aiGradingQuestion', 'faq.importQuestion', 'faq.pteQuestion',
  'cta.title', 'cta.subtitle', 'cta.primary', 'cta.secondary', 'footer.tagline',
  'footer.productTitle', 'footer.productBuilder', 'footer.productFeedback',
...
export const DE_SPOT_KEYS = [
  'announcement.message', 'hero.badge', 'hero.subtitle', 'hero.microcopy',
  'flow.stepOne', 'flow.stepThree', 'trustedBy.label',
  'features.eyebrow', 'features.title', 'features.aiGrading.title',
  'features.analytics.description',
  'featureDetail.title', 'featureDetail.checkTwo', 'featureDetail.card.title',
  'featureDetail.card.scoreVocabulary',
  'stats.deliveredValue', 'stats.deliveredLabel', 'stats.accuracyLabel', 'stats.savedLabel',
