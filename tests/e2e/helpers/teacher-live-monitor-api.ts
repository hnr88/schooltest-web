...
// Task 037 — the Node-side half of the live-monitoring harness (C-TS-3, C-SJ-1).
// Nothing here fixtures a tile: every state is read LIVE off the same Strapi the
// browser polls and parsed through the SHIPPED Zod mirror, so a payload that
// diverges from .qa/CONTRACTS.md throws here instead of being matched loosely.
